...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T48XecE9G?p=31)
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对汽车客运站管理系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对汽车客运站管理系统进行介绍时，将按照如下内容进行。

第一部分：介绍汽车客运站管理系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发汽车客运站管理系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对汽车客运站管理系统的功能要求，以及对汽车客运站管理系统的性能要求等；
...
# 第2章 开发环境与技术
汽车客运站管理系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对汽车客运站管理系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，汽车客运站管理系统开发可行。
### 3.1.3 操作可行性
汽车客运站管理系统根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作汽车客运站管理系统。
...
| :-: | :-: | :-: | :-: | :-: |
|id|int(11)|否||主键|
|car\_name|varchar(200)|是|NULL|车辆名字  |
|car\_driver|varchar(200)|是|NULL|司机  |
|repair\_content|varchar(200)|是|NULL|车辆描述|
|car\_types|int(11)|是|NULL|车辆类型  |
|car\_number|varchar(200)|是|NULL|车牌号  |
|start|varchar(200)|是|NULL|始发站  |
|end|varchar(200)|是|NULL|终点站  |
|sell\_money|decimal(10,2)|是|NULL|车票金额|
...
| :-: | :-: | :-: | :-: | :-: |
|id|int(11)|否||主键|
|car\_id|varchar(200)|是|NULL|车辆id|
|scheduling\_types|int(11)|是|NULL|排班  |
|create\_time|timestamp|是|NULL|创建时间|
表4.3 售票信息表
...
|id|int(11)|否||主键|
|car\_id|varchar(200)|是|NULL|车辆id|
|actual\_money|decimal(10,2)|是|NULL|售卖金额|
|shoupiao\_types|int(11)|是|NULL|售票状态  |
|create\_time|timestamp|是|NULL|创建时间|
表4.4 管理员信息表
